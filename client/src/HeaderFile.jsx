  ...
  const {user}=useContext(UserContext)
    return (
      <header className=' flex justify-between'>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-11 h-11 -rotate-90">
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
  </svg>
  <div class="flex flex-col">
  <h1 class="font-bold text-xl">bookat</h1>
  <p class="text-sm ">Booking made Simple..!</p>
          ...
          <div className='flex gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300'>
            <div>Anywhere</div>
            <div className="flex border boder-l border-gray-300"></div>
            <div>Any week</div>
            <div className="border boder-l border-gray-300"></div>
            <div>Add guests</div>
